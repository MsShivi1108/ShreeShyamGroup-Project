export const mockProperties = [
  {
    ...
    location: "150m from Kursi Road, 5 km from Tedhi Puliya, 50m from Scorpio Club, Kursi Road, Lucknow",
    price: 2551,
    priceUnit: "sq. ft.",
    size: "--",
    description: "30 ft wide main road, with 24 ft & 22 ft branch roads,Electricity & street lights, Green area & gated society, Proper drainage & shaded trees, Close to Night Safari & Zoo, Connected to the main Scorpio Club road",
